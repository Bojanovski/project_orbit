...
{
    bool shouldUseDarkStyle()
    {
        return dark_style_windows::isDarkTheme();
    }

    void useDarkStyleOnApplication()
    {
        QApplication::setStyle(new DarkStyle);
    }

    void useDarkStyleOnWidget(QWidget *target)
    {
        dark_style_windows::setDark_Titlebar(reinterpret_cast<HWND>(target->winId()));
    }
}
