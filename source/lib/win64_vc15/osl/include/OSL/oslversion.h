...
#define OSL_VERSION_PATCH 0
#define OSL_VERSION_TWEAK 1
...
#define OSL_LIBRARY_VERSION_TWEAK 1
...
namespace OSL_v1_13_0 { }
namespace OSL = OSL_v1_13_0;

// Macros to use in each file to enter and exit the right name spaces.
#define OSL_NAMESPACE OSL_v1_13_0
#define OSL_NAMESPACE_STRING "OSL_v1_13_0"
#define OSL_NAMESPACE_ENTER namespace OSL_v1_13_0 {
